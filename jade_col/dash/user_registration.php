...
<head>
	...
	<title>Jade Col | user_registration</title>
                              ...
                              <div class="row">
                                  <div class="col-sm-12">
									<div style="text-align:center;">
										<img src="../images/jade_logo.png"  height="70" width="150">
									</div>
                                  ...
                                  <div class="col-sm-6  col-sm-offset-3">
									  ...
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="register_user_submit" name='finish' value='Register' />
