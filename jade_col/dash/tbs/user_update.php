...
<head>
	...
	<title>Jade Collections | Update Customer</title>
							...
							<h3>
                                ...
                                <div class="col-sm-12">
									<div class="col-sm-6 col-sm-offset-3" style="text-align:center;">
									  ...
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="update_member_submit" name='finish' value='Update Details' />
