...
<head>
	...
	<title>Jade Col | Recover Password</title>
            ...
            <div class="wizard-container">
                ...
                <!--        You can switch ' data-color="green" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
						...
						<div class="wizard-navigation">
							<ul>
	                            <li><a href="#profile" data-toggle="tab">Password Recovery</a></li>
	                        </ul>
						</div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="profile">
                              <div class="row">
                                  <div class="col-sm-12">
										<h4 class="info-text"> Please enter your username and email </h4>
                                  </div>
								  
                                  <div class="col-sm-6 col-sm-offset-3">
                                      <div class="form-group">
                                          <div class="input-group">
                                              <input type="text" class="form-control" id="recover_pass_name" placeholder="Username">
                                              <span class="input-group-addon"><i class="material-icons">face</i></span>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <div class="input-group">
                                              <input type="email" class="form-control" id="recover_pass_email" placeholder="Email">
                                              <span class="input-group-addon"><i class="material-icons">email</i></span>
                                          </div>
                                      </div>
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="recover_pass_submit" name='finish' value='Send Request' />
