...
<div class="w3-main">
	<div class="agile-info">
		<h3  style="text-align:center;">Your account please!</h3>
		<p  style="text-align:center;">You haven't been logged in yet, thus cannot access this page .</p>
		<a href="../login/index.html"  style="text-align:center;"><i class="fa fa-angle-double-left" aria-hidden="true"></i>Login</a>
	</div>
</div>
