...
<div class="w3-main">
	<div class="agile-info">
		<h3>Twins ???</h3>
		<p>Please use other details<br> An account exists with part of the details you just entered.</p>
		<a href="../login/sign_up.html"><i class="fa fa-angle-double-left" aria-hidden="true"></i>Sign Up</a>
	</div>
</div>
