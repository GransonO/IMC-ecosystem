...
<!doctype html>
	<html lang="en">
		<body>
									...
									<h3>
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="welcome">
												<div class="row">
													<div class="col-sm-12">
														<h4 class="info-text" style="text-align:center; color:blue;"> JADE COLLECTIONS LOYALTY PROGRAM </h4>
													</div>
			...
			$mail_message_txt = 'Welcome to the Jade Collections Loyalty Program';
			$message_subject = 'Welcome to the Jade Collections Loyalty Program';
			...
			$message = (new Swift_Message($message_subject))
			  ...
			  ->setTo([$register_email_address,'JadeCollectionsrewards@indulgencemarketing.co.ke'])
