...
<head>
	...
	<title>Jade Collections | Login</title>
                            ...
                            <div class="tab-pane" id="profile">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">									
                                        ...
                                        <div class="col-sm-2 col-sm-offset-1">
                                            <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Access the Front Desk account">
                                                <input type="radio" name="type" value="Apartment">
                                                <div class="icon">
		                                          <i><img src="../images/frontdesk.png" width="75" height="75" onclick='myProfile("FRONTDESK"); return false;'></i>
                                                </div>
                                                <h6>Customer Care</h6>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane" id="sign_in">
                              <div class="row">
                                  ...
                                  <div class="col-sm-6  col-sm-offset-3">
                                    ...
                                    <input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="log_me_in_btn" name='finish' value='Login' />
									<br>
