...
<head>
	...
	<title>Kongoni | User Details</title>
            ...
            <div class="wizard-container">
                ...
                <!--        You can switch ' data-color="green" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
						...
						<div class="wizard-navigation">
							<ul>
	                            <li><a href="#profile" data-toggle="tab">Guest Status</a></li>
	                        </ul>
						</div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="profile">
                              <div class="row">
                                ...
                                <div class="col-sm-6 col-sm-offset-3">
									<div style="text-align:center;">
										<input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="query_user_submit" name='finish' value='Get Guest Details' />
									</div>
									
										<h4 class="info-text"><small><u> User Details </u></small></h4>
								</div>																		
									<div class="col-sm-12  col-sm-offset-1">
											 <div class="form-group col-sm-5">
											  <div class="input-group">
												  <input type="text" class="form-control" id="reward_name" placeholder="Customer Name" disabled>
                                              <span class="input-group-addon"><i class="material-icons"></i></span>
											  </div>
											</div>
											 <div class="form-group col-sm-5">
											  <div class="input-group">
												  <input type="text" class="form-control" id="reward_status" placeholder="Status(New, Frequent, Top)" disabled>
                                              <span class="input-group-addon"><i class="material-icons"></i></span>
											  </div>
											</div>
											<div class="form-group col-sm-10 label-floating">
												<select name="reward_selector" id="reward_selector" class="form-control">
												<option value="#">Available reward options</option>
												<!--Gets populated by chosen country -->
												</select>
											</div>
                                  </div>
                                ...
                                <div class="col-sm-6 col-sm-offset-3">
									<div style="text-align:center;">
										<input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="reward_guest_submit" name='finish' value='Reward Guest' />
