                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Top Member</i></h4>
                            <div class="left col-xs-7">
                              <h2>Nicole Pearson</h2>
                              <ul class="list-unstyled">
                                <li><i class="fa fa-envelope"></i> Email: nicolepar@npgroup,com</li>
                                <li><i class="fa fa-phone"></i> Phone #: +051 782600272</li>
                                <li><i class="fa fa-calendar"></i> Joined #: 2017-02-07</li>
                                <li><i class="fa fa-suitcase"></i> No of visits #: 15</li>
                                <li><i class="fa fa-star"></i> Rewarded #: 5</li>
                              </ul>
                            </div>
                          ...
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis">
                              ...
                              <a href="rpt/profile.php?mode=B-K-0001&name=Nicole Pearson" class="btn btn-primary btn-xs">
