...
$query = "SELECT *
          ...
          ORDER BY `total_points_redeemed` DESC LIMIT 5;";
...
$purchase_query = "SELECT SUM(`transaction_amount`) AS total_purchase FROM member_transactions";
...
<html lang="en">
  <head>
	...
	if(empty($_POST['redeemed_value']) === false){
		$_SESSION['redeemed_value'] = $_POST['redeemed_value'];
		
		$AvailablePoints =  $_SESSION['Available'];
		$AmountRedeemed = $_POST['redeemed_value'];
		...
		$The_Company = trim($_SESSION['company']);
		...
		header('Location: redemption_qualifier.php?AvailablePoints=$AvailablePoints');
		}
	}	
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="../dash" class="site_title"><i class="fa fa-pagelines"></i> <span>Private Collection</span></a>
            </div>
        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="row top_tiles" >
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats"   style="text-align: center;">             
					<div class="count"><small><?php echo 0//$loyalty; ?></small></div>
				  <h3><strong><i class="fa fa-pagelines"></i></strong></h3>
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats"   style="text-align: center;">
				  ...
				  <h3><strong><i class="fa fa-pagelines"></i></strong></h3>
                  <h3>Total Expired Points</h3>
                </div>
              </div>			  
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats"   style="text-align: center;">
                     <div class="count"><small><?php echo 0//$redeem; ?></small></div>
				  <h3><strong><i class="fa fa-pagelines"></i></strong></h3>
	  ...
	  <!-- Active Profiles -->   
		<div class="row">
              <div class="col-md-4">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Top Guests <small>Based on visits and purchases</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <article class="media event">
                      ...
                      <div class="media-body">
                               <a class="title" href="#"><?php echo $first_name; ?></a>
                              <p><strong>Ksh <?php echo number_format($first_amount); ?> </strong> Total Amount Spent </p>
                              <p> <small><?php echo $F_pur; ?> Nights Spent  </small><strong><i class="fa fa-pagelines"></i></strong><small>  <?php echo $F_count; ?> No of rewards</small></p>
                      </div>
                    </article>
                    <article class="media event">
                      <a class="pull-left date">
                      ...
                      <div class="media-body">
                              <a class="title" href="#"><?php echo $sec_name; ?></a>
                              <p><strong>Ksh <?php echo number_format($sec_amount); ?> </strong> Total Amount Spent </p>
                              <p> <small><?php echo $S_pur; ?> Spend   </small><strong><i class="fa fa-pagelines"></i></strong><small>  <?php echo $S_count; ?> No of rewards </small></p>
                      </div>
                    </article>
                    <article class="media event">
                      <a class="pull-left date">
                      ...
                      <div class="media-body">
                              <a class="title" href="#"><?php echo $third_name; ?></a>
                              <p><strong>Ksh <?php echo number_format($third_amount); ?> </strong> Total Amount Spent </p>
                              <p> <small><?php echo $T_pur; ?> Nights Spent   </small><strong><i class="fa fa-pagelines"></i></strong><small>  <?php echo $T_count; ?> No of rewards </small></p>
                      </div>
                    </article>
                    <article class="media event">
                      <a class="pull-left date">
                      ...
                      <div class="media-body">
                              <a class="title" href="#"><?php echo $forth_name; ?></a>
                              <p><strong>Ksh <?php echo number_format($forth_amount); ?>. </strong> Total Amount Spent </p>
                              <p> <small><?php echo $FO_pur; ?> Nights Spent   </small><strong><i class="fa fa-pagelines"></i></strong><small>  <?php echo $FO_count; ?> No of rewards </small></p>
                      </div>
                    </article>
                    <article class="media event">
                      <a class="pull-left date">
                      ...
                      <div class="media-body">
                              <a class="title" href="#"><?php echo $fifth_name; ?></a>
                              <p><strong>Ksh <?php echo number_format($fifth_amount); ?>. </strong> Total Amount Spent </p>
                              <p> <small><?php echo $FI_pur; ?> Nights Spent </small><strong><i class="fa fa-pagelines"></i></strong><small>  <?php echo $FI_count; ?> No of rewards </small></p>
                      </div>
                    </article>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Frequent Guests <small>Based on number of visits</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <article class="media event">
              ...
              <div class="col-md-4">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>New Guests <small>Most recently enrolled</small></h2>
                    ...
                    <div class="x_content">
                      ...
                      <a class="pull-left date">
                        <p class="month">Pos</p>
                        <p class="day"><?php echo $total_c_count; ?></p>
                      </a>
                      <div class="media-body">
                                <p><a class="title" href="#">  <?php echo $last_name; ?>  </a></p> 
                              <p><strong> <?php echo $last_id; ?> </strong> <i class="fa fa-pagelines"></i><strong> <?php echo $current_date; ?>. </strong></p>
                              <p> <small><?php echo $L_points_count; ?> Nights Spent</small>
                              </p>
                      </div>
                    </article>
                        <article class="media event">
                      <a class="pull-left date">
                        <p class="month">Pos</p>
                        <p class="day"><?php echo $total_c_count - 1; ?></p>
                      </a>
                      <div class="media-body">
                                <P><a class="title" href="#"> <?php echo $sec_last_name; ?></a></p> 
                              <p><strong> <?php echo $sec_last_id; ?> </strong> <i class="fa fa-pagelines"></i><strong> <?php echo $current_date; ?>. </strong></p>
                              <p> <small><?php echo $sec_last_points_count; ?> Nights Spent</small>
                              </p>
                      </div>
                    </article>
                        <article class="media event">
                      <a class="pull-left date">
                        <p class="month">Pos</p>
                        <p class="day"><?php echo $total_c_count - 2; ?></p>
                      </a>
                      <div class="media-body">
                                <p><a class="title" href="#"> <?php echo $third_last_name; ?> </a></p> 
                              <p><strong> <?php echo $third_last_id; ?> </strong> <i class="fa fa-pagelines"></i><strong> <?php echo $current_date; ?>. </strong></p>
                              <p> <small><?php echo $third_last_points_count; ?> Nights Spent</small>
                              </p>
                      </div>
                    </article>
						<article class="media event">
                      <a class="pull-left date">
                        <p class="month">Pos</p>
                        <p class="day"><?php echo $total_c_count - 3; ?></p>
                      </a>
                      <div class="media-body">
                                <p><a class="title" href="#"> <?php echo $forth_last_name; ?></a></p> 
                              <p><strong> <?php echo $forth_last_id; ?> </strong> <i class="fa fa-pagelines"></i><strong> <?php echo $current_date; ?>. </strong></p>
                              <p> <small><?php echo $forth_last_points_count; ?> Nights Spent</small>
                              </p>
                      </div>
                    </article>
						<article class="media event">
                      <a class="pull-left date">
                        <p class="month">Pos</p>
                        <p class="day"><?php echo $total_c_count - 4; ?></p>
                      </a>
                      <div class="media-body">
                                <p><a class="title" href="#"> <?php echo $fifth_last_name; ?></a></p> 
                              <p><strong> <?php echo $fifth_last_id; ?> </strong> <i class="fa fa-pagelines"></i><strong> <?php echo $current_date; ?>. </strong></p>
                              <p> <small><?php echo $fifth_last_points_count; ?> Nights Spent</small>
                              </p>
                      </div>
                    </article>
                  </div>
