...
<head>
	...
	<title>Kongoni | Register Customer</title>
                    	...
                    	<div class="wizard-header">
							<h3>
								...
								<div class="wizard-navigation">
									<ul>
			                            <li><a href="#address" data-toggle="tab">Complete your Registration</a></li>
			                        </ul>
								</div>
		                                ...
		                                <div class="row">
		                                    ...
		                                    <div class="col-sm-5 col-sm-offset-1">
	                                        	<div class="form-group label-floating">
	                                    			...
	                                    			<input type="text" id="register_first_name" class="form-control">
	                                        	</div>
		                                    </div>
		                                    <div class="col-sm-5">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label">Last Name</label>
		                                            <input type="text" id="register_last_name" class="form-control">
		                                        </div>
		                                    </div>
		                                    <div class="col-sm-5 col-sm-offset-1">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label">Phone Number</label>
		                                            <input type="text" id="register_phone_number" class="form-control">
		                                        </div>
		                                    </div>
		                                    <div class="col-sm-5">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label">Email Address</label>
	                                            	<input type="email" id="register_email_address" class="form-control">
	                                            	</select>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-sm-12 col-sm-offset-1">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label"><p style="font-size:12;">1. Would you like to be registered in the loyalty program?</p></label>
													</br>
											...
											<form action="">
													...
													<input  style="font-size:12;"  type="radio" name="state" id="state" value="YES" checked> Yes     .

													<input  style="font-size:12;"  type="radio" name="state" id="state" value="NO"> No
		                                    ...
		                                    <div class="col-sm-10 col-sm-offset-1">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label"><p style="font-size:12;">2. What are your favourite travel destinations in Kenya?</p></label>
														<textarea class="form-control" id="destination_description" rows="5">
														</textarea>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-sm-10 col-sm-offset-1">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label"><p style="font-size:12;">3. When do you enjoy travelling with family for a weekend getaway?</p></label>
														<input type="text" id="weekend_entry" class="form-control">
		                                        </div>
		                                    </div>
											
		                                    <div class="col-sm-10 col-sm-offset-1">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label"><p style="font-size:12;">4. Any feedback you would like to give the management to improve the Kongoni Experience?</p></label>
														<textarea class="form-control " id="experience_description" rows="5">
														</textarea>
		                                        </div>
		                                    </div>
											
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="new_guest_extra_submit" name='finish' value='Post Details' />
