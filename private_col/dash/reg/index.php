                    	...
                    	<div class="wizard-header">
							<h3>
								...
								<div class="wizard-navigation">
									<ul>
			                            <li><a href="#address" data-toggle="tab">Create Your Account</a></li>
			                        </ul>
								</div>
		                        ...
		                        <div class="tab-content">
		                            ...
		                            <div class="tab-pane" id="address">
		                                <div class="row">
		                                    ...
		                                    <div class="col-sm-5 col-sm-offset-1">
		                                        <div class="form-group label-floating">
		                                            ...
		                                            <input type="text" id="register_id_card" class="form-control">
		                                        </div>
		                                    </div>
									  ...
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' id="register_new_guest_submit" name='finish' value='Submit Details' />
