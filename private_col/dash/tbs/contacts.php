        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<?php
					...
					$member_details_url = "member_details.php?mode=".$table_data['member_id']."&member_name=".$table_data['poc_name']."&email_address=".$table_data['email_address']."&mobile_number=".$table_data['mobile_number'];
						echo "<tr>";
						echo "<td><a href='$member_details_url'>" .$table_data['member_id'] . "</td>" ; 
						echo "<td><a href='$member_details_url'>" .$table_data['poc_name'] . "</td>" ; 		
						echo "<td><a href='$member_details_url'>" .$table_data['mobile_number'] . "</td>" ; 
						echo "<td><a href='$member_details_url'>" .$table_data['email_address'] . "</td>" ; 
						echo "</tr>";  
					}
 ?>  
                      </tbody>
