                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					if(empty($_POST)===false){
						...
						$Table_query  = "SELECT * FROM member_transactions  WHERE `is_deleted` = '0' AND `transaction_date` BETWEEN '$from_date' AND '$to_date' ";
					...
					while($table_data = mysqli_fetch_assoc($table_query)){
						...
						echo "<td>" .$table_data['transaction_date'] . "</td>" ; 		
						echo "<td>" .$table_data['transaction_code'] . "</td>" ; 
						echo "<td>" .$table_data['transaction_amount'] . "</td>" ; 
						echo "<td>" .$table_data['loyalty_earned'] . "</td>" ; 
						echo "</tr>";  
					}
				}
				else{
					//Queries customer table values
					$Table_query  = "SELECT * FROM member_transactions  WHERE `is_deleted` = '0'";
