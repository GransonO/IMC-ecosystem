...
<html lang="en">
  <head>
    ...
    <title> <i class="fa fa-suitcase"> Red.. Receipt | Naivasha Konngoni Lodge<small><h2> Executed by <Strong><?php echo $username?></Strong></br></br> Signature: ________________________  <small>(for verification of the transaction)</small></h2></small></br> <small>Details:</small> </title>
...
echo '
				  ...
				  <li><a><i class="fa fa-edit"></i> Receipts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="receipts.php"> Program Receipts</a></li>
                    </ul> 
                  </li>
			  ...
			  <li><a><i class="fa fa-bell-o"></i>Engagement Platforms <span class="fa fa-chevron-down"></span></a>
				  ...
				  <li><a> <i class="fa fa-table"></i>Members Tables<span class="fa fa-chevron-down"></span></a>
				   <ul class="nav child_menu">
                      <li><a href="contacts.php?mode=contacts">Members Contacts</a></li>
                      <li><a href="loyalty.php?mode=loyalty">Loyalty Funds</a></li>
                      <li><a href="redemptions.php?mode=request">Redemption</a></li>
                      <li><a href="transactions.php?mode=transactions">Transaction</a></li>
                    </ul> 
				  </li>	
...
<?php
					if(empty($_POST)===false){
						...
						$Table_query  = "SELECT * FROM redemption_receipts WHERE `is_deleted` = '0' AND `redemption_date` BETWEEN '$from_date' AND '$to_date' ";
					...
					$Table_query  = "SELECT * FROM `redemption_receipts` ORDER BY `redemption_receipts`.`redemption_id` DESC";
