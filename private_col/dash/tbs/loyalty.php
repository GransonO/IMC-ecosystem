        ...
        <div class="right_col" role="main">
          <div class="">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Loyalty Available</th>
                          <th>Loyalty Expired</th>
			...
			<?php
					...
					$Table_query  = "SELECT * FROM member_loyalty_funds WHERE `is_deleted` = '0'";
					...
					while($table_data = mysqli_fetch_assoc($tablequery)){
						...
						echo "<td>" .$table_data['expired_loyalty'] . "</td>" ; 
