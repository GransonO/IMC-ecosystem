...
switch ($the_mode) {
	...
	$show_stuff = 'Members loyalty funds table is being displayed';
        break;
    case 'redemption':
	$show_stuff = 'Redemption Transactions table is being displayed';
        break;
    case 'transactions':
...
$mode_allowed = array('members','contacts','loyalty','redemption','transactions'); 
...
<html lang="en">
  <head>
    ...
    <title>RedemptionTables | Indulgence</title>
...
<?php
					if(empty($_POST)===false){
						...
						$Table_query  = "SELECT * FROM member_redemption_transactions WHERE `is_deleted` = 0 AND `created_at` BETWEEN '$from_date 00:00:00' AND '$to_date 23:59:59' ";
					...
					$Table_query  = "SELECT * FROM member_redemption_transactions WHERE `is_deleted` = 0 ";
