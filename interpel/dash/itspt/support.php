...
$profile = $U_query['profile'];
	...
	if(empty($_POST['req_title']) === false){
		
		$data_title = $_POST['req_title'];
		$data_body = $_POST['text_descr'];
		$message = '<html><body>
		<h1 style="color:#f40;">Assistance level '.$the_mode. '</h1>
		<p style="color:#080;font-size:13px;"> '.$data_body.' </br></p>
		<p style="color:#080;font-size:13px;"><h3> '.$username.' </h3></br></p>
		</body></html>'; 
		
		//Sends support mail
		support_mail($sender_email,'Assistance level '.$the_mode,$message);
	} 
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title" style="text-align:center;">
                    <h3> Requesting IT and Systems Support </h3>
                    ...
                    <form action="" method="post" class="form-horizontal form-label-left"> 
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="req_title" required="required" placeholder="Request Title" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <div id="alerts"></div>
                  <textarea class="editor-wrapper col-md-12 col-sm-12 col-xs-12" name="text_descr"></textarea>
                  <br/>  
                </div>
              </div>
            </div>
