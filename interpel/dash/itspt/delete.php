...
$user_id = $_SESSION['ID'];
$del_file = $_GET['ysyhnjxbyigjsanxioqsidhoyiwdhsbxjhushajlhdjiouhuowqehudbljsajixoiniwhqduxhiwbcuhxsiwaxbyivcvikwejlsanxkkzxnjoiuisw'];
?>
<!doctype html>
<html lang="en">
<head>
	...
	<title>Interpel CFS | Delete file</title>
                    	...
                    	<div class="wizard-header">
							<h3>
								...
								<div class="wizard-navigation">
									<ul>
			                            <li><a href="#address" data-toggle="tab">File Deletion</a></li>
			                        </ul>
								</div>
