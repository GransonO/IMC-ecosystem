                              ...
                              <div class="row">
                                  ...
                                  <div class="col-sm-6 col-sm-offset-3">
									...
									<div class="form-group">
									  ...
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-info btn-wd btn-sm' id="invite_user_submit" name='finish' value='Invite User' />
