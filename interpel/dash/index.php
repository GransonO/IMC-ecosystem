...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body blue">
      <div class="main_container">
	  
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="fa fa-anchor"></i> <span>Interpel CFS</span></a>
            </div>
	  ...
	  <!-- Active Profiles -->   
		<div class="row">
              ...
              <div class="col-md-4">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Top Profiles<small>Total Points Value</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <article class="media event">
              ...
              <div class="col-md-4">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Bottom Profiles <small>Points Value</small></h2>
