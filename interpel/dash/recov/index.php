...
<head>
	...
	<title>Interpel | Recover Password</title>
                            ...
                            <div class="tab-pane" id="profile">
                              <div class="row">
                                  ...
                                  <div class="col-sm-6 col-sm-offset-3">
									  ...
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-warning btn-wd btn-sm' id="recover_pass_submit" name='finish' value='Send Request' />
