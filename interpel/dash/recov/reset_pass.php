...
<head>
	...
	<title>Interpel | Reset Password</title>
                            ...
                            <div class="tab-pane" id="profile">
                              <div class="row">
                                  ...
                                  <div class="col-sm-6 col-sm-offset-3">
									  ...
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-warning btn-wd btn-sm' id="reset_password_submit" name='finish' value='Reset' />
