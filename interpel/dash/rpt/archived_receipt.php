...
//Redemption ID
$redeem_query = "SELECT `redemption_id` AS redeemed_id,`created_at` as last_red_date,`redeemed_amount` as requested FROM `member_redemption_transactions` WHERE `redemption_id` = '$red_id';";
              ...
              <div class="col-md-12 col-xs-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					$Table_query  = "SELECT * FROM `member_redemption_transactions` WHERE `redemption_id` = '$red_id' ORDER BY `created_at` DESC LIMIT 1;";
