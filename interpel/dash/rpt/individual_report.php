...
$members_total = "SELECT COUNT(`member_id`) AS member_count FROM `member_transactions` WHERE `member_id`='$the_id' AND `transaction_date` BETWEEN '$from_date' AND '$to_date' ";
$count_query =  mysqli_fetch_assoc(mysqli_query(Connect_Database(),$members_total));
$member_count = $count_query['member_count'];

//TOTAL
$members_totalX = "SELECT COUNT(`member_id`) AS member_count FROM `member_transactions` WHERE `transaction_date` BETWEEN '$from_date' AND '$to_date' ";
...
$members_last_date = "SELECT `max_trans_date` AS member_count FROM `member_loyalty_funds` WHERE `member_id`='$the_id'";
...
$members_amount = "SELECT SUM(`transaction_amount`) AS amount FROM `member_transactions` WHERE `member_id`='$the_id' AND `transaction_date` BETWEEN '$from_date' AND '$to_date' ";
$amount_query =  mysqli_fetch_assoc(mysqli_query(Connect_Database(),$members_amount));
$purchase_amount = $amount_query['amount'];

//TOTAL
$members_amountX = "SELECT SUM(`transaction_amount`) AS amount FROM `member_transactions` WHERE `transaction_date` BETWEEN '$from_date' AND '$to_date' ";
...
$members_loyalty = "SELECT SUM(`loyalty_earned`) AS amount FROM `member_transactions` WHERE `member_id`='$the_id' AND `transaction_date` BETWEEN '$from_date' AND '$to_date' ";
$loyalty_query =  mysqli_fetch_assoc(mysqli_query(Connect_Database(),$members_loyalty));
$loyalty_amount = $loyalty_query['amount'];

//TOTAL 
$members_loyaltyX = "SELECT SUM(`loyalty_earned`) AS amount FROM `member_transactions` WHERE `transaction_date` BETWEEN '$from_date' AND '$to_date' ";
...
$purchase_query = "SELECT SUM(`transaction_amount`) AS total_purchase FROM member_transactions WHERE `member_id`='$the_id' AND `transaction_date` BETWEEN '$from_date' AND '$to_date'";
                  ...
                  <div class="x_content">
					...
					<div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h1>
                              <img src="../../images/interpel.png"  height="100" width="200"> <?php echo $the_mode;?> Auto Program Report.
                      ...
                      <div class="row invoice-info col-xs-12 col-md-12 col-sm-12">
                        ...
                        <br>
                          ...
                          <br>
                          <b>Expired Loyalty:</b>  <?php echo $expire_points;?> Points
                          <br><b>Last Trans-Date:</b>  <?php echo $date_query;?>.
                          </div>
                        <!-- /.col -->
                      </div>
                      <!-- /.row -->

                        <p class="lead">Customer Details Between: <?php echo $from_date.' and '.$to_date;?></p>
