...
<head>
	...
	<title>Interpel | Register Customer</title>
							...
							<h3>
                                ...
                                <div class="col-sm-12">
									<div class="col-sm-6 col-sm-offset-3" style="text-align:center;">
									  ...
									  <div style="text-align:center;">
                                    <input type='button' class='btn btn-finish btn-fill btn-info btn-wd btn-sm' id="register_new_member_submit" name='finish' value='Submit Details' />
